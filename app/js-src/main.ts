            ...
            const loadContent = async (provider, embedDiv) => {
                ...
                if (endpoint) {
                    ...
                    try {
                        ...
                        if (data.prompt) {
                            // @ts-ignore
                            embedDiv.appendChild(createAiFooter(data.prompt, provider));
                        }
...
function createAiFooter(prompt: string, provider: string) {
    ...
    const geminiUrl = `https://gemini.google.com/app`; // No prompt prefill supported yet
    ...
    const runSynthesis = async (provider: string) => {
        ...
        try {
            ...
            if (data.error) {
                ...
                if (data.prompt) {
                    synthesisContent.appendChild(createAiFooter(data.prompt, provider));
                }
