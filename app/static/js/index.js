...
},{"process":"../../../../../usr/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/hybrids/src/utils.js":[function(require,module,exports) {
"use strict";
...
function compile(Hybrid, descriptors) {
  ...
  props.forEach(key => {
    ...
    if (config.connect) {
      callbacks.push(host => config.connect(host, key, options => {
      ...
      invalidate: () => {
        if (!invalidatePromise) {
          invalidatePromise = resolvedPromise.then(() => {
            cache.invalidate(config, config, {
              clearValue: true
            });
    ...
    try {
      ...
      if (result instanceof Promise) {
        result = result.then(data => {
          ...
          return syncCache(config, stringId, config.create(!config.list && stringId ? { ...data,
            id: stringId
          } : data));
...
function clear(model, clearValue = true) {
  ...
  if (config) {
    ...
    cache.invalidate(config, model.id, {
      clearValue,
      deleteEntry: true
    });
  } else {
...
function error(model, property) {
  ...
  if (property !== undefined && typeof state.error === "object" && state.error) {
  ...
  return (host, target) => {
    ...
    promise.then(value => {
      ...
      if (promiseMap.get(target) === promise) {
        (0, _value.default)(host, target, value);
        promiseMap.set(target, null);
      }
    });
  };
}
},{"../utils.js":"node_modules/hybrids/src/utils.js","./resolvers/value.js":"node_modules/hybrids/src/template/resolvers/value.js"}],"node_modules/hybrids/src/template/index.js":[function(require,module,exports) {
"use strict";
...
var rawRanking = JSON.parse(localStorage["ranking"] || '[]');
...
function loadGraph() {
  var colorNames = ["#1B9E77", "#D95F02", "#7570B3", "#E7298A"];
  var ctx = document.getElementById('myChart');
  var json = $('#proposal-data').text();
  var data = JSON.parse(json); // const fillPattern = ctx.createPattern(img, 'repeat');

  var colors = Object.values(data).map(function () {
    return colorNames.shift();
  });
  new Chart(ctx, {
    type: 'pie',
    data: {
...
require("./main");
},{"jquery":"node_modules/jquery/dist/jquery.js","./settings":"settings.ts","./main":"main.ts"}],"../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
